...
int ffsolo_allreduce(void * sndbuff, void * rcvbuff, int count, int16_t tag, ffoperator_h operator, ffdatatype_h datatype, int options, int async, ffschedule_h * _sched, int step, int groupsize){
    ...
    ffallreduce_nh(sndbuff, rcvbuff, count, tag, operator, datatype, options, &(state->allreduce_schedule), step, groupsize);
    ...
    ffallreduce(sndbuff, rcvbuff, count, MAX_INT16 - tag, operator, datatype, options, &(state->sync_allreduce_schedule));
    //ffallreduce_nh(sndbuff, rcvbuff, count, tag, operator, datatype, options, &(state->allreduce_schedule), step, groupsize);
